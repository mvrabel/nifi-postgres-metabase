CREATE USER dwh_metabase_user;
ALTER USER dwh_metabase_user WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS ENCRYPTED PASSWORD 'secret123';
